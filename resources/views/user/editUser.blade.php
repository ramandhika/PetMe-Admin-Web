        ...
        <div class="container mx-80 mt-7 mb-7">
            <form action="/user" method="POST">
                ...
                <div class="flex flex-col mt-5">
                    ...
                    <select name="role" id="role" class="border border-gray-300 rounded-md p-2.5 focus:outline-none focus:ring-2 focus:ring-purple-600 focus:border-transparent w-1/3">
